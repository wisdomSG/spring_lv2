...
public class WebSecurityConfig {
    ...
    @Bean
    // Authentication Manager 만들고 등록하는 메서드
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.addFilterBefore(jwtAuthenticationFilter(), UsernamePasswordAuthenticationFilter.class); //UsernamePasswordAuthenticationFilter가 수행되기전에 jwtAuthenticationFilter를 먼저 수행하겠다.
